...
#define JP_ORDER_TITLE   JP2("SQUARE %d,%d - TILE %02x", "\x8d\xbf\x95W %d,%d \x81\\ %02x")
...
#define JP_ATTACK        JP2("ATTACK THE GROUND", "\x93y\x92n\x82\xf0\x89\xfc\x82\xdf\x82\xe9")
