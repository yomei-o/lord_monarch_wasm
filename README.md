...
| | |
|---|---|
| ![map](docs/map.png) | `B_000.MAP` — 地形セット 10（草原） |
| ![pencil map](docs/map_pencil.png) | `B_005.MAP` — 地形セット 20。**体験版の「鉛筆王国」** |
| ![pencil tiles](docs/tiles_pencil.png) | セット 20 のタイル。色鉛筆・ノート・鉛筆の束・鉛筆削り |
