...
int FUN_1000_5fcb(undefined2 param_1)
...
LAB_1000_625d:
    iVar14 = 0x10;
    puVar18 = (uint *)(in_stack_00000000 + -2);
    piVar7 = unaff_DI;
    do {
      piVar20 = piVar7;
      puVar17 = puVar18;
    ...
    *(byte *)(puVar18 + uVar9) = (byte)puVar18[uVar9] + (byte)uVar12 + (((uint)unaff_DI & 1) != 0);
    uVar10 = (in_stack_00000000 + -2) * 0x100;
    ...
    piVar3 = (int *)(iVar16 + iVar11 + 0x10ff);
...
LAB_1000_5f7e:
  ...
  if (0x1f < bVar8) {
    if (bVar8 == 0x20) goto LAB_1000_5fc7;
    ...
    if ((0x7f < bVar8) && ((bVar8 < 0xa0 || (0xdf < bVar8)))) {
      ...
      if (CONCAT11(bVar8,*pbVar2) != 0x4081) {
        ...
        if ((0x2920 < uVar10) && (uVar10 < 0x2b7f)) goto LAB_1000_5fc1;
