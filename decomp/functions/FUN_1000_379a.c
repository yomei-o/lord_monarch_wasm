...

{
  ...
  *(uint *)(iVar19 + -2) = in_BX;
  *(undefined2 *)(iVar19 + -4) = 9;
  *(undefined2 *)(iVar19 + -6) = in_DX;
  *(undefined2 *)(iVar19 + -8) = 0x37a1;
  uVar43 = func_0x0001af48();
  if ((uint)unaff_BP[-5] <= (uint)uVar43) {
    in_BX = unaff_BP[-6];
    uVar43 = CONCAT22(unaff_BP[-8],unaff_BP[-5]);
  }
  *(uint *)(byte *)(in_BX + (int)unaff_SI) =
       *(int *)(byte *)(in_BX + (int)unaff_SI) + (int)((ulong)uVar43 >> 0x10) +
       (uint)((uint)uVar43 < (uint)unaff_BP[-1]);
  uVar18 = (uint)(byte)((char)uVar43 + (char)((ulong)uVar43 >> 8) * 't');
  ...
  if (uVar18 < (uint)unaff_BP[7]) {
    ...
    if (uVar18 * 2 <= unaff_SI[3]) {
      ...
      *(byte *)((int)unaff_SI + 0xf) = 4;
      ...
      unaff_BP[-1] = 0x37e2;
      func_0x0001ab65();
      puVar22 = (undefined1 *)((int)piVar20 + -2);
...
code_r0x000137e7:
        *(byte *)((int)unaff_SI + 0xb) = bVar7;
        if ((byte)unaff_SI[5] == 0xb) {
          puVar21 = (undefined2 *)(puVar22 + -2);
          puVar22 = puVar22 + -2;
          *puVar21 = 0x37f3;
          func_0x0001b6c0();
        }
      }
      return CONCAT22(*(undefined2 *)(puVar22 + 10),*(undefined2 *)(puVar22 + 0xe));
    }
  }
  piVar10 = unaff_BP + -1;
  unaff_BP[-1] = unaff_DS;
  ...
  uVar44 = CONCAT22(iVar34,CONCAT11(((int)uVar14 < 0) << 7 | uVar38 << 6 | in_AF << 4 |
                                    ((POPCOUNT(uVar14 & 0xff) & 1U) == 0) << 2,(byte)*puVar33)) |
           0x300;
  *(byte *)unaff_SI = (byte)*unaff_SI & (byte)*puVar33;
  if (unaff_DI != -1) {
    iVar35 = *unaff_BP;
    iVar34 = unaff_BP[1];
    uVar8 = unaff_BP[6];
    pcVar2 = (char *)(iVar34 + iVar35);
    *pcVar2 = *pcVar2 + (byte)uVar8;
    iVar16 = unaff_BP[7];
    pbVar1 = (byte *)(iVar34 + iVar35);
...
code_r0x0001387f:
  ...
  *pbVar1 = *pbVar1 + bVar7;
  if ((POPCOUNT(*pbVar1) & 1U) != 0) {
    ...
    bVar7 = *pbVar1;
    bVar15 = (byte)(uVar44 >> 0x10);
    bVar13 = *pbVar1;
    cVar17 = (char)(uVar44 >> 0x18) + *(byte *)(in_BX + (int)unaff_SI);
    *(byte *)(puVar36 + 0x39) = (byte)puVar36[0x39] - cVar17;
    ((byte *)((int)unaff_BP + (int)puVar36))[-0x178e] =
         ((byte *)((int)unaff_BP + (int)puVar36))[-0x178e] |
         (byte)(CONCAT22(CONCAT11(cVar17,bVar15 + bVar13),
                         (uVar9 + 0x5556) - (uint)CARRY1(bVar15,bVar7)) % (ulong)unaff_SI[0x410]);
    *(int *)(byte *)((int)unaff_BP + (int)puVar36) =
         *(int *)(byte *)((int)unaff_BP + (int)puVar36) >> 0x10;
...
code_r0x000138e6:
  *(uint *)((int)unaff_SI + 0x31) = *(uint *)((int)unaff_SI + 0x31) & (uint)unaff_SI;
  bVar37 = CARRY1((byte)in_BX,*(byte *)((int)unaff_BP + (int)unaff_SI));
  in_BX = CONCAT11((char)(in_BX >> 8),(byte)in_BX + *(byte *)((int)unaff_BP + (int)unaff_SI));
  puVar24 = (undefined1 *)piVar10;
code_r0x000138eb:
  *(undefined2 *)(puVar24 + -2) = unaff_SS;
  if (!bVar37) {
    puVar33 = puVar36;
    puVar36 = (uint *)((int)puVar36 + 1);
    *(byte *)puVar33 = 0x30;
    uVar9 = CONCAT11(0xaa,*(byte *)((int)unaff_BP + (int)puVar36) | 0x30) ^ 0x8a0;
    *(uint *)(puVar24 + -2) = in_BX;
    *(uint *)(puVar24 + -4) = uVar9;
    in_BX = unaff_SI[0x15];
    ...
    *(uint *)(puVar24 + -6) = CONCAT11(bVar13,bVar7);
    *(uint *)(puVar24 + -8) = uVar14;
    *(uint *)(puVar24 + -10) = uVar18;
    *(uint *)(puVar24 + -0xc) = in_BX;
    *(undefined1 **)(puVar24 + -0xe) = puVar24 + -4;
    *(int **)(puVar24 + -0x10) = unaff_BP;
    *(uint **)(puVar24 + -0x12) = unaff_SI;
    *(uint **)(puVar24 + -0x14) = puVar36;
    uVar9 = *puVar36;
    ...
    if (SCARRY1(cVar17,bVar7)) {
      piVar10 = *(int **)(puVar24 + -0x14);
      puVar30 = *(uint **)(byte *)((int)puVar36 + (in_BX - 0x18));
      puVar33 = puVar30 + 0x43a;
      uVar4 = *puVar33;
      *puVar33 = *puVar33 + 0x809;
      uVar14 = 0x4379;
      puVar30[0x43a] =
           puVar30[0x43a] + CONCAT11(bVar13 | (byte)uVar9,bVar7 | bVar15) + (uint)(0xf7f6 < uVar4);
    }
    else {
      *(undefined2 *)(puVar24 + -0x16) = 0x874;
      piVar10 = (int *)(puVar24 + -0x18);
      *(undefined2 *)(puVar24 + -0x18) = 0x874;
      puVar30 = unaff_SI;
    }
LAB_1000_3958:
    *(uint *)(byte *)((int)puVar36 + 0x55) = *(int *)(byte *)((int)puVar36 + 0x55) + uVar18;
    unaff_SI = (uint *)((int)puVar30 + 1);
    out((byte)*puVar30,uVar18);
    uVar9 = CONCAT11((byte)(in_BX >> 8) & ((byte *)((int)unaff_BP + (int)unaff_SI))[0x11],
                     (char)in_BX);
    bVar13 = (byte)uVar18;
    cVar42 = SBORROW1(bVar13,(byte)puVar30[0x39]);
    bVar7 = (byte)puVar30[0x39];
    cVar17 = (char)(bVar13 - bVar7) < '\0';
    bVar37 = bVar13 == bVar7;
    puVar25 = (uint *)((int)piVar10 + -2);
    *(undefined2 *)((int)piVar10 + -2) = 0x396b;
    bVar7 = func_0x0001b3ed();
    iVar16 = extraout_DX_00;
    if (!bVar37) {
      *(byte *)(puVar30 + 6) = bVar7;
      *(undefined2 *)((int)puVar25 + -2) = 0x3973;
    ...
    if (cVar42 != cVar17) {
      iVar16 = iVar16 + 1;
      puVar25[-1] = (uint)puVar36;
      puVar25[-2] = iVar16;
      puVar25[-3] = CONCAT11((char)(uVar14 >> 8),8);
      puVar25[-4] = uVar9;
      if (iVar16 == 0) {
LAB_1000_39c7:
        pcVar6 = (code *)swi(1);
      ...
      ((byte *)((int)unaff_BP + (int)puVar36))[0x6e] =
           ((byte *)((int)unaff_BP + (int)puVar36))[0x6e] | (byte)((uint)iVar16 >> 8);
code_r0x00013985:
      pbVar1 = (byte *)((int)puVar36 + uVar9 + 0x12);
      *(byte **)pbVar1 = (byte *)((int)puVar36 + *(int *)pbVar1 + 2);
      puVar26 = (undefined1 *)0x2e1c;
      *(undefined2 *)0x2e1c = 0x3990;
      FUN_1000_8d53();
      *(undefined2 *)(puVar26 + -2) = 0x399f;
      func_0x00018e51();
      pcVar6 = (code *)swi(3);
      uVar44 = (*pcVar6)();
      return uVar44;
    ...
    unaff_DS = *puVar25;
    bVar37 = bVar7 < ((byte *)((int)unaff_BP + (int)unaff_SI))[-0x74a1] ||
             bVar7 == ((byte *)((int)unaff_BP + (int)unaff_SI))[-0x74a1];
    puVar33 = (uint *)CONCAT22(uVar8,puVar25);
    *puVar25 = 0x39ba;
    piVar45 = (int *)FUN_1000_a1b8();
    piVar10 = (int *)piVar45;
    if (bVar37) {
      if (uVar14 == 1) {
        do {
          ...
          do {
            ...
            if (((*unaff_SI & 0x80) == 0) && ((unaff_SI[5] & 0x20) != 0)) {
              ...
              *(byte *)((int)unaff_BP + (int)puVar36) = 0xff;
              in_ST0 = in_ST0 / (longdouble)*(float *)(unaff_BP + 2);
              piVar11 = (int *)*(uint *)puVar33;
              puVar33 = (uint *)CONCAT22((int)((ulong)puVar33 >> 0x10),(uint *)puVar33 + 1);
              puVar30 = unaff_SI + 8;
              puVar36 = unaff_SI;
            }
            iVar16 = iVar16 + -1;
          ...
          unaff_SI = (uint *)*(uint *)puVar33;
          puVar33 = (uint *)CONCAT22((int)((ulong)puVar33 >> 0x10),(uint *)puVar33 + 1);
          puVar30 = puVar36;
code_r0x00013a16:
          uVar8 = (undefined2)((ulong)puVar33 >> 0x10);
          puVar27 = (uint *)puVar33;
          if (0x1ef < uVar14) goto code_r0x00013a1c;
          ((byte *)((int)unaff_BP + (int)puVar30))[0x59] =
               ((byte *)((int)unaff_BP + (int)puVar30))[0x59] | (byte)uVar14;
          bVar7 = *(byte *)(uVar14 + puVar27[1]);
          puVar27[1] = (uint)unaff_SI;
          *(char *)0xaaaa = *(char *)0xaaaa + (byte)uVar14 + ((byte)((char)unaff_BP + 1U) < bVar7);
          ...
          puVar36 = (uint *)puVar27[1];
          puVar33 = (uint *)CONCAT22(uVar8,puVar27 + 2);
    ...
    out((int)((ulong)piVar45 >> 0x10),(char)piVar45);
    puVar3 = unaff_SI;
    bVar37 = CARRY2(*puVar3,(uint)piVar10);
    *puVar3 = *puVar3 + (int)piVar10;
    bVar40 = (int)*puVar3 < 0;
    bVar39 = *puVar3 == 0;
    bVar7 = POPCOUNT(*puVar3 & 0xff);
    uVar14 = uVar14 - 1;
    if (uVar14 == 0 || bVar39) goto LAB_1000_39c7;
    goto LAB_1000_3a35;
  }
  in_BX = in_BX + 1;
  puVar22 = puVar24 + -4;
  *(undefined2 *)(puVar24 + -4) = 0x810;
...
code_r0x00013b57:
  ...
  *(int **)(puVar22 + -2) = unaff_BP;
  puVar32 = puVar22 + -4;
  *(int **)(puVar22 + -4) = unaff_BP;
  pbVar1 = (byte *)(in_BX + (int)unaff_SI);
  bVar7 = (byte)(uVar44 >> 8);
  bVar37 = CARRY1(*pbVar1,bVar7);
  *pbVar1 = *pbVar1 + bVar7;
  in_BX = in_BX - 1;
  goto LAB_1000_3b62;
LAB_1000_381b:
  bVar37 = bVar7 < 0x10;
  bVar41 = SBORROW1(bVar7,'\x10');
  bVar40 = (char)(bVar7 - 0x10) < '\0';
  bVar39 = bVar7 == 0x10;
  if (!bVar37) {
    if (7 < bVar7) {
      bVar41 = SBORROW1(bVar7,'\f');
      bVar40 = (char)(bVar7 - 0xc) < '\0';
      bVar39 = bVar7 == 0xc;
      bVar37 = true;
      if (bVar7 < 0xc) goto LAB_1000_383e;
    }
    if (bVar7 != 0) {
      bVar41 = SBORROW1(bVar7,'\x05');
      bVar40 = (char)(bVar7 - 5) < '\0';
      bVar39 = bVar7 == 5;
      bVar37 = true;
    ...
    bVar39 = bVar7 == 5;
    if (!bVar39) {
      uVar14 = CONCAT11(((byte *)((int)unaff_BP + (int)puVar36))[-0x80],0xb);
      pbVar1 = (byte *)(in_BX + (int)unaff_SI);
      *pbVar1 = *pbVar1 & 0xb;
      if (*pbVar1 != 0) goto code_r0x0001386c;
FUN_1000_38de:
      piVar10 = (int *)(puVar22 + -2);
      *(undefined2 *)(puVar22 + -2) = 0x38e1;
      FUN_1000_7494();
...
code_r0x0001386c:
  ...
  pbVar1 = (byte *)((int)puVar36 + in_BX + 0x854);
  *pbVar1 = *pbVar1 & 0xb;
  uVar38 = *pbVar1 == 0;
  puVar23 = (undefined1 *)0x322e;
  *(undefined2 *)0x322e = 0x3877;
  func_0x0001ab45();
  piVar10 = (int *)(puVar23 + -2);
  *(undefined2 *)(puVar23 + -2) = 0x387a;
...
code_r0x00013a1c:
  unaff_SS = *puVar27;
  *(longdouble *)(uVar14 + (int)puVar30) = in_ST0;
  puVar33 = (uint *)CONCAT22(uVar8,(uint *)(puVar27[1] + -2));
  *(undefined2 *)(puVar27[1] + -2) = unaff_ES;
  uVar9 = puVar30[2];
  piVar10 = (int *)(uint)*(byte *)((int)puVar30 + -0x79);
  bVar37 = (byte)iVar16 < *(byte *)((int)unaff_BP + (int)unaff_SI);
  ...
  LOCK();
  puVar36 = (uint *)unaff_BP[-0x17];
  unaff_BP[-0x17] = (int)puVar30;
  UNLOCK();
  in_ST0 = in_ST1;
  in_ST1 = in_ST2;
  in_ST2 = in_ST3;
...
LAB_1000_3a35:
  if (bVar39) {
    *(byte *)(uVar9 + (int)unaff_SI) = *(byte *)(uVar9 + (int)unaff_SI) + 1;
    puVar28 = (uint *)puVar33;
    puVar33 = (uint *)CONCAT22((int)((ulong)puVar33 >> 0x10),puVar28 + -1);
    puVar28[-1] = unaff_ES;
    if (0xbbc4 < CONCAT11(bVar40 << 7 | bVar39 << 6 | in_AF << 4 | ((bVar7 & 1) == 0) << 2 | 2 |
                          bVar37,(char)piVar10)) {
      ((byte *)((int)unaff_BP + (int)puVar36))[-0x54ee] =
           ((byte *)((int)unaff_BP + (int)puVar36))[-0x54ee] | (byte)(uVar9 >> 8);
      puVar3 = puVar36;
      puVar36 = (uint *)((int)puVar36 + 1);
...
LAB_1000_3a63:
    ...
    *(byte *)0x7479 = *(byte *)0x7479 | (byte)(uVar9 >> 8);
    puVar29 = (uint *)puVar33;
    uVar8 = (undefined2)((ulong)puVar33 >> 0x10);
    puVar29[-1] = unaff_ES;
    pbVar1 = (byte *)((int)unaff_SI + uVar9 + 0x222);
    *(byte **)pbVar1 = (byte *)(*(int *)pbVar1 + (int)puVar36);
    puVar36 = (uint *)puVar29[-1];
    unaff_SI = (uint *)*puVar29;
    unaff_BP = (int *)puVar29[1];
    uVar14 = puVar29[5];
    uVar12 = puVar29[6];
    uVar18 = CONCAT11((char)(puVar29[3] >> 8),(byte)puVar29[3] | *(byte *)0x5d02) |
             *(uint *)((byte *)((int)unaff_BP + (int)puVar36) + 10);
    puVar29[6] = (uint)puVar36;
    pbVar1 = (byte *)((int)unaff_SI + uVar18 + 0x2c2);
    cVar42 = SCARRY1((char)uVar12,*pbVar1);
    bVar37 = (char)((char)uVar12 + *pbVar1) < '\0';
    puVar30 = puVar29 + 5;
    puVar29[5] = 0x3a83;
    ...
    *(undefined1 *)0x1108 = (char)uVar18;
    cVar17 = (char)((ulong)uVar43 >> 0x18);
    if (bVar37) {
      bVar15 = (byte)(uVar18 >> 8);
      puVar33 = (uint *)((int)puVar36 + -0x53);
      uVar5 = (uint)(bVar15 < (byte)(uVar14 >> 8));
      uVar9 = *puVar33;
      uVar4 = *puVar33;
      *puVar33 = uVar4 + 0xe02d + uVar5;
      bVar13 = *(byte *)((int)unaff_BP + (int)puVar36);
      bVar15 = bVar15 + (byte)unaff_SI[0x1015] | (byte)((ulong)uVar43 >> 8);
      in_BX = CONCAT11(bVar15,(char)uVar18);
      if ((char)bVar15 < '\0') {
        bVar37 = unaff_SI[3] < 1000;
        if (!bVar37) {
                    /* WARNING: Call to offcut address within same function */
          *(undefined2 *)((int)puVar30 + -2) = 0x3b26;
          puVar30 = (uint *)((int)puVar30 + -2);
          uVar43 = func_0x00013966();
          if (!bVar37) goto LAB_1000_3b55_1;
        }
        puVar32 = (undefined1 *)((int)puVar30 + -2);
        *(undefined2 *)((int)puVar30 + -2) = 0x3b2d;
        ...
        if (bVar37) {
          ...
          puVar24 = puVar32 + -2;
          *(undefined2 *)(puVar32 + -2) = 0x3b38;
          bVar37 = false;
          goto code_r0x000138eb;
        }
        puVar31 = puVar32 + -2;
        *(undefined2 *)(puVar32 + -2) = 0x3b42;
        uVar43 = FUN_1000_3607();
        bVar7 = (byte)uVar43;
        if (bVar37) {
          puVar22 = puVar31 + -2;
          *(undefined2 *)(puVar31 + -2) = 0x3b47;
          goto code_r0x000137e7;
        }
LAB_1000_3b55_1:
      ...
      puVar33 = (uint *)ZEXT24((undefined1 *)((int)puVar30 + -2));
      *(undefined2 *)((int)puVar30 + -2) = unaff_CS;
      iVar16 = CONCAT11(cVar17 - *(byte *)((int)unaff_SI + in_BX + 0x23c9),
                        (char)((ulong)uVar43 >> 0x10) + bVar13 +
                        (0x1fd2 < uVar9 || CARRY2(uVar4 + 0xe02d,uVar5)));
      ((byte *)((int)unaff_BP + (int)puVar36))[0x5555] =
           ((byte *)((int)unaff_BP + (int)puVar36))[0x5555] + (char)uVar14;
...
LAB_1000_3b12:
  return CONCAT22(*(undefined2 *)((int)puVar30 + 10),*(undefined2 *)((int)puVar30 + 0xe));
}
