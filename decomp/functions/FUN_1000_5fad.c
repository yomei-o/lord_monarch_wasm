...
int FUN_1000_5fad(int param_1,undefined2 param_2)
...
LAB_1000_5f7e:
  ...
  if (0x1f < bVar8) {
    if (bVar8 != 0x20) {
      ...
      if (CONCAT11(bVar8,*pbVar2) == 0x4081) goto LAB_1000_5fb0;
      uVar10 = FUN_1000_8401();
      if ((uVar10 < 0x2921) || (0x2b7e < uVar10)) {
        FUN_1000_5c7d(uVar25);
        goto code_r0x00015fad;
      }
      FUN_1000_5c7d(uVar25);
      uVar25 = 0x5fc7;
