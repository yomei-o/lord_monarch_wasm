...

{
  ...
  unaff_DI[iVar12 + -0x3d] = unaff_DI[iVar12 + -0x3d] & 6;
  iVar7 = 5;
  uVar5 = 0;
  uVar10 = 0;
  iVar12 = -0x386e;
    ...
    if (uVar5 < uVar10) {
      ...
      *pbVar1 = bVar3 - (iVar7 != 0);
      ...
      iVar12 = CONCAT11((char)((uint)(iVar13 + 0x17) >> 8),
                        (byte)(iVar13 + 0x17) | unaff_DI[iVar13 + 0x76]);
      puVar8 = unaff_DS;
    }
    else {
      puVar15 = unaff_DI + uVar10 * -0x50;
      FUN_1000_4b82();
      do {
        *puVar15 = 0x5a;
  ...
  *(undefined2 *)0x8470 = uVar11;
  func_0x0001f552();
  LOCK();
  iVar12 = *(int *)((int)puVar8 + (int)puVar2);
