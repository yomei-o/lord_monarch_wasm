...

{
  ...
  if (in_CX == 1 || (char)(cVar8 + (char)((uint)in_CX >> 8)) != '\0') {
    puVar12 = &stack0x0002 + iVar7;
    *(undefined2 *)(&stack0x0002 + iVar7) = 0x961f;
    FUN_1000_8cec();
  ...
  puVar9 = (undefined2 *)(&stack0x0002 + iVar7);
  *(undefined2 **)(&stack0x0002 + iVar7) = unaff_BP;
  cVar8 = '\f';
  do {
    unaff_BP = unaff_BP + -1;
    puVar9 = puVar9 + -1;
  ...
  *(undefined1 **)(auStack_18 + iVar7) = &stack0x0002 + iVar7;
  puVar10 = &stack0x4a28 + iVar7;
  *(undefined2 *)(&stack0x4a28 + iVar7) = 0x95ef;
  FUN_1000_5e03();
  puVar11 = puVar10 + -2;
