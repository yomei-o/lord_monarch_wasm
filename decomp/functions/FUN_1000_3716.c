...

{
  ...
  iVar20 = (int)in_ESP;
  *(int *)((int)in_BX + 0x23) = iVar20;
  cVar16 = *(char *)(unaff_SI + 0x5b);
  *(char *)(unaff_SI + 0x5b) = '\0';
  *(int *)(unaff_BP + unaff_SI) =
       *(int *)(unaff_BP + unaff_SI) + in_AX + (uint)((char)(cVar16 << 7) < '\0');
  uVar37 = (undefined2)((ulong)in_ESP >> 0x10);
  *(uint *)(iVar20 + -2) = in_CX;
  puVar40 = (uint *)((unaff_SI - in_BX[0x318]) - (uint)(in_AX < 0x21c));
  uVar8 = *(undefined2 *)(iVar20 + -2);
  *in_BX = *in_BX ^ unaff_BP;
  puVar36 = (uint *)((int)puVar40 + unaff_BP + 0x55);
  uVar12 = *puVar36;
  *puVar36 = *puVar36 >> 0xd;
  puVar36 = puVar40;
  iVar15 = (in_CX & 3) - (*puVar36 & 3);
  *puVar36 = *puVar36 + (uint)(0 < iVar15) * iVar15;
  ...
  *(uint *)(unaff_BP - 0x2e) = unaff_DI;
  UNLOCK();
  *(undefined2 *)(iVar20 + -2) = uVar8;
  *(uint *)(iVar20 + -4) = in_CX;
  *(undefined2 *)(iVar20 + -6) = in_DX;
  *(uint *)(iVar20 + -8) = uVar17;
  *(int *)(iVar20 + -10) = iVar20;
  *(uint *)(iVar20 + -0xc) = unaff_BP;
  *(undefined2 *)(iVar20 + -0xe) = puVar40;
  *(uint *)(iVar20 + -0x10) = uVar12;
  puVar36 = (uint *)(unaff_BP + (int)puVar40);
  uVar18 = *puVar36;
  uVar14 = *puVar36;
  *puVar36 = *puVar36 - unaff_BP;
  uVar9 = *puVar36;
  uVar4 = *puVar36;
  uVar5 = *puVar36;
  *(undefined2 *)(iVar20 + -0x12) = unaff_CS;
  *(uint *)(iVar20 + -0x14) =
       (uint)(in_NT & 1) * 0x4000 | (uint)SBORROW2(uVar14,unaff_BP) * 0x800 |
  ...
  puVar21 = (undefined1 *)(iVar20 + -0x16);
  *(undefined2 *)(iVar20 + -0x16) = 0x3743;
  FUN_1000_3c36();
  puVar22 = puVar21 + -2;
  *(undefined2 *)(puVar21 + -2) = 0x3746;
  ...
  *(int *)((int)puVar22 + -0xe) = (int)puVar22 + -4;
  *(uint *)(puVar22 + -0x10) = unaff_BP;
  *(uint **)(puVar22 + -0x12) = puVar40;
  puVar39 = puVar22 + -0x14;
  *(uint *)(puVar22 + -0x14) = uVar12;
  iVar15 = -*puVar40;
  uVar14 = (uint)(puVar22 + -0x14 < (undefined1 *)*puVar40);
  ...
  *(uint *)(byte *)(uVar18 + (int)puVar40) =
       *(int *)(byte *)(uVar18 + (int)puVar40) + (int)((ulong)uVar49 >> 0x10) +
  ...
  if (uVar9 < *(uint *)(puVar22 + -6)) {
    uVar14 = puVar40[3] + uVar9 * -2;
    uVar44 = uVar14 == 0;
    if (uVar9 * 2 <= puVar40[3]) {
      *(byte *)(puVar40 + 5) = (byte)iVar15;
      puVar40[4] = uVar18;
      *(byte *)((int)puVar40 + 0xf) = 4;
      ...
      *(undefined2 *)(puVar24 + -2) = 0x37e5;
      ...
      if (!(bool)uVar44) {
code_r0x000137e7:
        *(byte *)((int)puVar40 + 0xb) = bVar7;
        if ((byte)puVar40[5] == 0xb) {
  ...
  puVar27 = (undefined2 *)(puVar22 + -0x16);
  *(uint *)(puVar22 + -0x16) = unaff_DS;
  puVar36 = puVar40;
  puVar40 = (uint *)((int)puVar40 + 1);
  uVar50 = CONCAT22(uVar8,CONCAT11(((int)uVar14 < 0) << 7 | uVar44 << 6 | in_AF << 4 |
                                   ((POPCOUNT(uVar14 & 0xff) & 1U) == 0) << 2,(byte)*puVar36)) |
           0x300;
  *(byte *)puVar40 = (byte)*puVar40 & (byte)*puVar36;
  if (uVar12 != 0xffff) {
    iVar41 = *(int *)(puVar22 + -0x14);
    iVar38 = *(int *)(puVar22 + -0x12);
    uVar8 = *(undefined2 *)(puVar22 + -8);
    pcVar1 = (char *)(iVar38 + iVar41);
    *pcVar1 = *pcVar1 + (byte)uVar8;
    iVar15 = *(int *)(puVar22 + -6);
    pbVar2 = (byte *)(iVar38 + iVar41);
  ...
  uVar12 = iVar15 + *(int *)(byte *)((int)puVar40 + uVar18 + 0xb44);
  puVar42 = (uint *)0x0;
code_r0x0001387f:
  uVar14 = (uint)(uVar50 >> 0x10);
  uVar9 = CONCAT11((char)(uVar50 >> 8),(byte)puVar40[5]) & 0xffd0 | 5;
  bVar7 = (byte)uVar9;
  *(byte *)(puVar40 + 5) = bVar7;
  swi(4);
  pcVar1 = puVar39 + (int)puVar40;
  *pcVar1 = *pcVar1 + bVar7;
  if ((POPCOUNT(*pcVar1) & 1U) != 0) {
    pbVar2 = (byte *)((int)puVar40 + uVar18 + 0x33);
    bVar7 = *pbVar2;
    bVar13 = (byte)(uVar50 >> 0x10);
    bVar19 = *pbVar2;
    cVar16 = (char)(uVar50 >> 0x18) + *(byte *)(uVar18 + (int)puVar40);
    *(byte *)(puVar42 + 0x39) = (byte)puVar42[0x39] - cVar16;
    (puVar39 + (int)puVar42)[-0x178e] =
         (puVar39 + (int)puVar42)[-0x178e] |
         (byte)(CONCAT22(CONCAT11(cVar16,bVar13 + bVar19),
                         (uVar9 + 0x5556) - (uint)CARRY1(bVar13,bVar7)) % (ulong)puVar40[0x410]);
    *(int *)(puVar39 + (int)puVar42) = *(int *)(puVar39 + (int)puVar42) >> 0x10;
    return CONCAT22(puVar27[1],*puVar27);
  }
  puVar33 = puVar40;
  if (*pcVar1 == '\0') goto LAB_1000_3958;
code_r0x000138e6:
  *(uint *)((int)puVar40 + 0x31) = *(uint *)((int)puVar40 + 0x31) & (uint)puVar40;
  bVar43 = CARRY1((byte)uVar18,puVar39[(int)puVar40]);
  uVar18 = CONCAT11((char)(uVar18 >> 8),(byte)uVar18 + puVar39[(int)puVar40]);
  puVar11 = (undefined1 *)puVar27;
code_r0x000138eb:
  *(undefined2 *)(puVar11 + -2) = unaff_SS;
  if (!bVar43) {
    ...
    *(byte *)puVar36 = 0x30;
    uVar9 = CONCAT11(0xaa,puVar39[(int)puVar42] | 0x30) ^ 0x8a0;
    *(uint *)(puVar11 + -2) = uVar18;
    *(uint *)(puVar11 + -4) = uVar9;
    uVar18 = puVar40[0x15];
    uVar14 = (uVar14 | 0x3000) - *(int *)(byte *)(uVar18 + (int)puVar40);
    bVar19 = (byte)(uVar9 >> 8);
    bVar7 = (char)uVar9 + 8;
    ...
    *(uint **)(puVar11 + -0x14) = puVar42;
    ...
    if (SCARRY1(cVar16,bVar7)) {
      puVar27 = *(undefined2 **)(puVar11 + -0x14);
      puVar33 = *(uint **)(byte *)((int)puVar42 + (uVar18 - 0x18));
      puVar36 = puVar33 + 0x43a;
      uVar4 = *puVar36;
      *puVar36 = *puVar36 + 0x809;
      uVar12 = 0x4379;
      puVar33[0x43a] =
           puVar33[0x43a] + CONCAT11(bVar19 | (byte)uVar9,bVar7 | bVar13) + (uint)(0xf7f6 < uVar4);
    }
    else {
      *(undefined2 *)(puVar11 + -0x16) = 0x874;
      puVar27 = (undefined2 *)(puVar11 + -0x18);
      *(undefined2 *)(puVar11 + -0x18) = 0x874;
      puVar33 = puVar40;
    }
LAB_1000_3958:
    *(uint *)(byte *)((int)puVar42 + 0x55) = *(int *)(byte *)((int)puVar42 + 0x55) + uVar14;
    puVar40 = (uint *)((int)puVar33 + 1);
    out((byte)*puVar33,uVar14);
    uVar18 = CONCAT11((byte)(uVar18 >> 8) & (puVar39 + (int)puVar40)[0x11],(char)uVar18);
    bVar19 = (byte)uVar14;
    cVar48 = SBORROW1(bVar19,(byte)puVar33[0x39]);
    bVar7 = (byte)puVar33[0x39];
    cVar16 = (char)(bVar19 - bVar7) < '\0';
    bVar43 = bVar19 == bVar7;
    puVar28 = (uint *)((int)puVar27 + -2);
    *(undefined2 *)((int)puVar27 + -2) = 0x396b;
    bVar7 = func_0x0001b3ed();
    iVar15 = extraout_DX_00;
    if (!bVar43) {
      *(byte *)(puVar33 + 6) = bVar7;
      *(undefined2 *)((int)puVar28 + -2) = 0x3973;
    ...
    if (cVar48 != cVar16) {
      iVar15 = iVar15 + 1;
      puVar28[-1] = (uint)puVar42;
      puVar28[-2] = iVar15;
      puVar28[-3] = CONCAT11((char)(uVar12 >> 8),8);
      puVar28[-4] = uVar18;
      if (iVar15 == 0) {
LAB_1000_39c7:
        pcVar6 = (code *)swi(1);
      ...
      (puVar39 + (int)puVar42)[0x6e] = (puVar39 + (int)puVar42)[0x6e] | (byte)((uint)iVar15 >> 8);
code_r0x00013985:
    ...
    in_AF = 9 < ((bVar7 ^ puVar39[(int)puVar40]) & 0xf) | in_AF;
    bVar7 = (bVar7 ^ puVar39[(int)puVar40]) + in_AF * '\x06' & 0xf;
    unaff_DS = *puVar28;
    bVar43 = bVar7 < (byte)(puVar39 + (int)puVar40)[-0x74a1] ||
             bVar7 == (puVar39 + (int)puVar40)[-0x74a1];
    puVar36 = (uint *)CONCAT22(uVar37,puVar28);
    *puVar28 = 0x39ba;
      ...
      if (uVar12 == 1) {
        do {
          ...
          do {
            ...
            puVar33 = puVar40;
            if (((*puVar40 & 0x80) == 0) && ((puVar40[5] & 0x20) != 0)) {
              puVar36 = puVar36 + -2;
              *puVar36 = unaff_DS;
              bVar7 = (byte)puVar11 | 0x17;
              bVar19 = (byte)((uint)puVar11 >> 8);
              if (bVar19 == (byte)puVar40[6]) {
                puVar11 = (undefined1 *)CONCAT11(bVar7 / 0x5e,bVar7 % 0x5e);
                puVar33 = puVar42;
                goto code_r0x00013a16;
              }
              uVar12 = CONCAT11(bVar19 & puVar39[(int)puVar40],(byte)puVar11) | 0x17;
              *(byte *)(puVar40 + 0x3931) = (byte)puVar40[0x3931] ^ (byte)((uint)iVar15 >> 8);
              puVar39[(int)puVar42] = 0xff;
              in_ST0 = in_ST0 / (longdouble)*(float *)(puVar39 + 4);
              puVar11 = (undefined1 *)*(uint *)puVar36;
              puVar36 = (uint *)CONCAT22((int)((ulong)puVar36 >> 0x10),(uint *)puVar36 + 1);
              puVar33 = puVar40 + 8;
              puVar42 = puVar40;
            }
            iVar15 = iVar15 + -1;
          ...
          puVar40 = (uint *)*(uint *)puVar36;
          puVar36 = (uint *)CONCAT22((int)((ulong)puVar36 >> 0x10),(uint *)puVar36 + 1);
          puVar33 = puVar42;
code_r0x00013a16:
          uVar8 = (undefined2)((ulong)puVar36 >> 0x10);
          puVar30 = (uint *)puVar36;
          if (0x1ef < uVar12) goto code_r0x00013a1c;
          (puVar39 + (int)puVar33)[0x59] = (puVar39 + (int)puVar33)[0x59] | (byte)uVar12;
          bVar7 = *(byte *)(uVar12 + puVar30[1]);
          puVar30[1] = (uint)puVar40;
          *(char *)0xaaaa = *(char *)0xaaaa + (byte)uVar12 + ((byte)((char)puVar39 + 1U) < bVar7);
          puVar10 = (undefined1 *)CONCAT11((char)((uint)puVar39 >> 8),(char)puVar39 + -0x3b);
          puVar42 = (uint *)puVar30[1];
          puVar36 = (uint *)CONCAT22(uVar8,puVar30 + 2);
          puVar40 = (uint *)0xc800;
          puVar39 = puVar11;
        } while( true );
      }
  ...
  *(byte *)(puVar40 + 1) = (byte)puVar40[1] | (byte)uVar14;
  goto FUN_1000_38de;
LAB_1000_3b62:
  puVar10 = puVar35;
  if (bVar43) {
...
code_r0x00013b57:
  ...
  *(undefined1 **)(puVar10 + -4) = puVar39;
  pbVar2 = (byte *)(uVar18 + (int)puVar40);
  bVar7 = (byte)(uVar50 >> 8);
...
LAB_1000_381b:
  ...
  if (!bVar43) {
    ...
    bVar45 = bVar7 == 5;
    if (!bVar45) {
      uVar12 = CONCAT11((puVar39 + (int)puVar42)[-0x80],0xb);
      pbVar2 = (byte *)(uVar18 + (int)puVar40);
      *pbVar2 = *pbVar2 & 0xb;
      if (*pbVar2 != 0) goto code_r0x0001386c;
FUN_1000_38de:
      puVar27 = (undefined2 *)(puVar10 + -2);
      *(undefined2 *)(puVar10 + -2) = 0x38e1;
      FUN_1000_7494();
      *(byte *)(uVar18 + (int)puVar40) = *(byte *)(uVar18 + (int)puVar40) & (byte)uVar12;
      LOCK();
      uVar44 = puVar39[0x72];
...
code_r0x0001386c:
  ...
  *(undefined2 *)0x322e = 0x3877;
  func_0x0001ab45();
  puVar27 = (undefined2 *)(puVar26 + -2);
  *(undefined2 *)(puVar26 + -2) = 0x387a;
  uVar50 = func_0x0001b476();
  if (!(bool)uVar44) {
    *(byte *)((int)puVar40 + 0xb) = (byte)uVar50;
  }
  goto code_r0x0001387f;
code_r0x00013a1c:
  unaff_SS = *puVar30;
  *(longdouble *)(uVar12 + (int)puVar33) = in_ST0;
  puVar36 = (uint *)CONCAT22(uVar8,(uint *)(puVar30[1] + -2));
  *(undefined2 *)(puVar30[1] + -2) = unaff_ES;
  uVar18 = puVar33[2];
  puVar10 = (undefined1 *)(uint)*(byte *)((int)puVar33 + -0x79);
  bVar43 = (byte)iVar15 < (byte)puVar39[(int)puVar40];
  cVar16 = (byte)iVar15 - puVar39[(int)puVar40];
  uVar12 = CONCAT11((char)((uint)iVar15 >> 8),cVar16);
  bVar46 = cVar16 < '\0';
  bVar45 = cVar16 == '\0';
  bVar7 = POPCOUNT(cVar16);
  LOCK();
  puVar42 = *(uint **)(puVar39 + -0x2e);
  *(uint **)(puVar39 + -0x2e) = puVar33;
  UNLOCK();
  in_ST0 = in_ST1;
  in_ST1 = in_ST2;
  in_ST2 = in_ST3;
...
LAB_1000_3a35:
  if (bVar45) {
    *(byte *)(uVar18 + (int)puVar40) = *(byte *)(uVar18 + (int)puVar40) + 1;
    puVar31 = (uint *)puVar36;
    puVar36 = (uint *)CONCAT22((int)((ulong)puVar36 >> 0x10),puVar31 + -1);
    puVar31[-1] = unaff_ES;
    if (0xbbc4 < CONCAT11(bVar46 << 7 | bVar45 << 6 | in_AF << 4 | ((bVar7 & 1) == 0) << 2 | 2 |
                          bVar43,(char)puVar10)) {
      (puVar39 + (int)puVar42)[-0x54ee] = (puVar39 + (int)puVar42)[-0x54ee] | (byte)(uVar18 >> 8);
      puVar3 = puVar42;
      puVar42 = (uint *)((int)puVar42 + 1);
      *(byte *)puVar3 = (char)puVar10 + 0x3b;
      goto LAB_1000_3a63;
    }
    puVar39 = puVar39 + uVar12;
    pbVar2 = (byte *)((uVar18 >> 2) + (int)puVar40);
    *pbVar2 = *pbVar2 - 0x15;
    puVar3 = (uint *)(puVar39 + (int)puVar42 + 0x645);
    uVar14 = *puVar3;
    *puVar3 = *puVar3 - uVar12;
    bVar7 = ((char)(uVar18 >> 1) + (char)(uVar18 >> 2) + -0x10) - (uVar14 < uVar12) | 2;
    iVar15 = *(int *)(byte *)((int)puVar42 + 0x55);
code_r0x00013aab:
    puVar39[(int)puVar40] = puVar39[(int)puVar40] & bVar7;
    ((uint *)puVar36)[-1] = (uint)puVar39;
    puVar39[(int)puVar40] = puVar39[(int)puVar40] & (byte)uVar12;
    puVar33 = (uint *)0xf029;
    *(uint *)0xf029 = (uint)puVar39;
    ...
    if (((*puVar40 & 0x80) != 0) || (*(byte *)((int)puVar40 + 0xb) != 0xff)) goto LAB_1000_3b12;
    if ((byte)puVar40[5] != 0) {
code_r0x00013b04:
      if ((byte)uVar18 == (byte)puVar40[6]) goto LAB_1000_3b12;
...
LAB_1000_3a63:
    ...
    *(byte *)0x7479 = *(byte *)0x7479 | (byte)(uVar18 >> 8);
    puVar32 = (uint *)puVar36;
    uVar37 = (undefined2)((ulong)puVar36 >> 0x10);
    puVar32[-1] = unaff_ES;
    pbVar2 = (byte *)((int)puVar40 + uVar18 + 0x222);
    *(byte **)pbVar2 = (byte *)(*(int *)pbVar2 + (int)puVar42);
    puVar42 = (uint *)puVar32[-1];
    puVar40 = (uint *)*puVar32;
    puVar39 = (undefined1 *)puVar32[1];
    uVar12 = puVar32[5];
    uVar8 = puVar32[6];
    uVar18 = CONCAT11((char)(puVar32[3] >> 8),(byte)puVar32[3] | *(byte *)0x5d02) |
             *(uint *)(puVar39 + (int)puVar42 + 10);
    puVar32[6] = (uint)puVar42;
    pbVar2 = (byte *)((int)puVar40 + uVar18 + 0x2c2);
    ...
    *(undefined1 *)0x1108 = (char)uVar18;
    ...
    if (bVar43) {
      ...
      puVar36 = (uint *)((int)puVar42 + -0x53);
      uVar4 = (uint)(bVar19 < (byte)(uVar12 >> 8));
      uVar14 = *puVar36;
      uVar9 = *puVar36;
      *puVar36 = uVar9 + 0xe02d + uVar4;
      cVar48 = puVar39[(int)puVar42];
      bVar19 = bVar19 + (byte)puVar40[0x1015] | (byte)((ulong)uVar49 >> 8);
      uVar18 = CONCAT11(bVar19,(char)uVar18);
      if ((char)bVar19 < '\0') {
        bVar43 = puVar40[3] < 1000;
        if (!bVar43) {
...
LAB_1000_3b55_1:
      ...
      puVar36 = (uint *)ZEXT24((undefined1 *)((int)puVar33 + -2));
      *(undefined2 *)((int)puVar33 + -2) = unaff_CS;
      iVar15 = CONCAT11(cVar16 - *(byte *)((int)puVar40 + uVar18 + 0x23c9),
                        (char)((ulong)uVar49 >> 0x10) + cVar48 +
                        (0x1fd2 < uVar14 || CARRY2(uVar9 + 0xe02d,uVar4)));
      (puVar39 + (int)puVar42)[0x5555] = (puVar39 + (int)puVar42)[0x5555] + (char)uVar12;
      goto code_r0x00013aab;
    }
    if (cVar48 == '\0') {
      *(byte *)((int)puVar40 + 0xb) = *(byte *)((int)puVar40 + 0xb) + cVar16;
      goto code_r0x00013b04;
    }
code_r0x00013b09:
    if ((byte)puVar40[5] != 2) goto LAB_1000_3b12;
  }
  *(byte *)(puVar40 + 5) = (byte)(uVar18 >> 8);
LAB_1000_3b12:
