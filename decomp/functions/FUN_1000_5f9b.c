...
int FUN_1000_5f9b(undefined2 param_1)
...
LAB_1000_625d:
    ...
    *(byte *)puVar17 = (byte)*puVar17 ^ bVar8;
    pbVar2 = (byte *)((int)piVar19 + 0x4f);
    *pbVar2 = *pbVar2 + bVar8;
    *(byte *)((int)piVar19 + 0x4f) = bVar8;
    puVar20 = (undefined1 *)((int)piVar19 + 0x51);
    uVar12 = iVar11 + 1;
    *(byte *)(puVar17 + uVar10) = (byte)puVar17[uVar10] + (byte)uVar12 + (((uint)unaff_DI & 1) != 0)
    ;
...
LAB_1000_5f7e:
  do {
    ...
    unaff_SI = unaff_SI + 1;
    bVar8 = *pbVar2;
    uVar9 = CONCAT11((char)((ulong)uVar23 >> 8),bVar8);
    uVar23 = CONCAT22(in_DX,uVar9);
    if (bVar8 < 0x20) {
FUN_1000_6259:
      out(in_DX,uVar9);
      goto LAB_1000_625d;
...
LAB_1000_5fc7:
  ...
  pbVar2 = unaff_SI;
  unaff_SI = unaff_SI + 1;
  in_AX = CONCAT11(bVar8,*pbVar2);
  in_ZF = in_AX == 0x4081;
  goto code_r0x00015f9b;
}
