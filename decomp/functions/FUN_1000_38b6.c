...

{
  ...
  do {
    ...
    bVar6 = (byte)in_AX | (byte)unaff_SI[3];
    puVar16 = (uint *)in_ESP;
    uVar28 = (undefined2)((ulong)in_ESP >> 0x10);
    if (0x13 < CONCAT11(bVar10,bVar6)) {
      puVar18 = puVar16 + -1;
      puVar16[-1] = 0x38f3;
    ...
    uVar31 = (undefined1)in_BX;
    cVar13 = (char)(in_BX >> 8) + (byte)unaff_SI[-0x2af1];
    in_BX = CONCAT11(cVar13,uVar31);
    puVar27 = unaff_DI;
    unaff_DI = (uint *)((int)unaff_DI + 1);
    *(byte *)puVar27 = bVar6 - 0x12;
    bVar7 = bVar6 + 0x29;
    if (bVar7 != 0) goto LAB_1000_3948;
    cVar35 = *(char *)0x5108;
    in_AX = CONCAT11(bVar10,cVar35);
  } while (0xc4 < (byte)(bVar6 - 0x12));
  ...
  in_BX = CONCAT11(cVar13 + cVar35,uVar31);
code_r0x000138d9:
  in_BX = in_BX + 1;
...
code_r0x000138eb:
  ...
  if (!bVar30) {
    ...
    unaff_DI = (uint *)((int)unaff_DI + 1);
    *(byte *)puVar27 = 0x30;
    uVar36 = CONCAT22(in_DX,CONCAT11(0xaa,*(byte *)(unaff_BP + (int)unaff_DI) | 0x30)) | 0x30000000;
code_r0x000138fb:
    uVar8 = (uint)uVar36 ^ 0x8a0;
    *(uint *)((int)puVar18 + -2) = in_BX;
    *(uint *)((int)puVar18 + -4) = uVar8;
    in_BX = unaff_SI[0x15];
    ...
    *(undefined2 *)((int)puVar18 + -6) = CONCAT11(bVar10,bVar7);
    ...
    *(undefined2 *)((int)puVar18 + -0x14) = unaff_DI;
    bVar10 = bVar10 | (byte)*unaff_DI;
    cVar13 = (char)(in_CX >> 8);
    in_CX = CONCAT11(cVar13 + bVar7,(char)in_CX);
    unaff_BP = 0x874;
    if (SCARRY1(cVar13,bVar7)) {
...
LAB_1000_3948:
      ...
      *(uint *)(byte *)(unaff_BP + (int)unaff_SI) =
           *(int *)(byte *)(unaff_BP + (int)unaff_SI) + CONCAT11(bVar10,bVar7 | (byte)uVar12) +
           (uint)(0xf7f6 < uVar8);
    }
    else {
...
LAB_1000_3958:
    *(int *)(byte *)((int)unaff_DI + 0x55) = *(int *)(byte *)((int)unaff_DI + 0x55) + in_DX;
    ...
    uVar8 = CONCAT11((byte)(in_BX >> 8) & *(byte *)((int)puVar23 + unaff_BP + 0x11),(char)in_BX);
    bVar10 = (byte)in_DX;
    cVar35 = SBORROW1(bVar10,(byte)unaff_SI[0x39]);
    bVar6 = (byte)unaff_SI[0x39];
    cVar13 = (char)(bVar10 - bVar6) < '\0';
    bVar30 = bVar10 == bVar6;
    uVar28 = (undefined2)((ulong)in_ESP >> 0x10);
...
code_r0x00013985:
    ...
    bVar6 = bVar6 ^ *(byte *)(unaff_BP + (int)puVar23);
            ...
            if (((*puVar23 & 0x80) == 0) && ((puVar23[5] & 0x20) != 0)) {
              ...
              *puVar27 = unaff_DS;
              ...
              if (bVar10 == (byte)puVar23[6]) {
                uVar8 = CONCAT11(bVar6 / 0x5e,bVar6 % 0x5e);
                puVar29 = unaff_DI;
                goto code_r0x00013a16;
              }
              uVar12 = CONCAT11(bVar10 & *(byte *)(unaff_BP + (int)puVar23),(byte)uVar8) | 0x17;
...
LAB_1000_381b:
  bVar6 = (byte)uVar8;
  bVar30 = bVar6 < 0x10;
  bVar34 = SBORROW1(bVar6,'\x10');
  bVar33 = (char)(bVar6 - 0x10) < '\0';
  bVar32 = bVar6 == 0x10;
  if (!bVar30) {
    cVar13 = '\x04';
    if (7 < bVar6) {
      bVar34 = SBORROW1(bVar6,'\f');
      bVar33 = (char)(bVar6 - 0xc) < '\0';
      bVar32 = bVar6 == 0xc;
      bVar30 = true;
    ...
    cVar13 = '\b';
    if (bVar6 != 0) {
      bVar34 = SBORROW1(bVar6,'\x05');
      bVar33 = (char)(bVar6 - 5) < '\0';
      bVar32 = bVar6 == 5;
      bVar30 = true;
    ...
    if (!bVar32) {
      ...
      *(undefined2 *)(puVar15 + -2) = 0x387a;
      ...
      uVar8 = CONCAT11((char)((ulong)uVar37 >> 8),(byte)unaff_SI[5]) & 0xffd0 | 5;
      bVar6 = (byte)uVar8;
      ...
      *pbVar1 = *pbVar1 + bVar6;
      if ((POPCOUNT(*pbVar1) & 1U) != 0) {
        ...
        bVar6 = *pbVar1;
        bVar7 = (byte)((ulong)uVar37 >> 0x10);
        bVar10 = *pbVar1;
        cVar13 = (char)((ulong)uVar37 >> 0x18) + *(byte *)(in_BX + (int)unaff_SI);
        *(byte *)(unaff_DI + 0x39) = (byte)unaff_DI[0x39] - cVar13;
        pbVar1 = (byte *)((int)unaff_DI + unaff_BP + 0xe872);
        *pbVar1 = *pbVar1 | (byte)(CONCAT22(CONCAT11(cVar13,bVar7 + bVar10),
                                            (uVar8 + 0x5556) - (uint)CARRY1(bVar7,bVar6)) %
...
code_r0x00013a1c:
  ...
  *(undefined2 *)(puVar20[1] + -2) = unaff_ES;
  ...
  cVar13 = (byte)iVar11 - *(byte *)(unaff_BP + (int)puVar23);
  in_CX = CONCAT11((char)((uint)iVar11 >> 8),cVar13);
  bVar33 = cVar13 < '\0';
  bVar32 = cVar13 == '\0';
...
LAB_1000_3a35:
  if (bVar32) {
    *(byte *)(uVar8 + (int)puVar23) = *(byte *)(uVar8 + (int)puVar23) + 1;
    ...
    puVar21[-1] = unaff_ES;
    if (0xbbc4 < CONCAT11(bVar33 << 7 | bVar32 << 6 | in_AF << 4 | ((bVar6 & 1) == 0) << 2 | 2 |
                          bVar30,(char)uVar12)) {
    ...
    *pbVar1 = *pbVar1 - 0x15;
    ...
    uVar12 = *puVar2;
    *puVar2 = *puVar2 - in_CX;
    bVar6 = ((char)(uVar8 >> 1) + (char)(uVar8 >> 2) + -0x10) - (uVar12 < in_CX) | 2;
...
LAB_1000_3a63:
    ...
    *(byte **)pbVar1 = (byte *)(*(int *)pbVar1 + (int)unaff_DI);
    ...
    cVar35 = SCARRY1((char)uVar9,*pbVar1);
    ...
    *(undefined1 *)0x1108 = (char)uVar8;
    cVar13 = (char)((ulong)uVar37 >> 0x18);
    if (bVar30) {
      bVar7 = (byte)(uVar8 >> 8);
      puVar27 = (uint *)((int)unaff_DI + -0x53);
      uVar4 = (uint)(bVar7 < (byte)(in_CX >> 8));
      uVar12 = *puVar27;
      uVar3 = *puVar27;
      *puVar27 = uVar3 + 0xe02d + uVar4;
      bVar10 = *(byte *)(unaff_BP + (int)unaff_DI);
      bVar7 = bVar7 + (byte)unaff_SI[0x1015] | (byte)((ulong)uVar37 >> 8);
      in_BX = CONCAT11(bVar7,(char)uVar8);
      if ((char)bVar7 < '\0') {
...
LAB_1000_37ea_2:
          if (cVar13 == '\0' && *(byte *)(unaff_BP + (int)unaff_DI) == 0) {
...
LAB_1000_3b55_1:
        uVar8 = CONCAT11((char)((uint)uVar9 >> 8),(char)uVar9 + -0x80) | 1;
code_r0x00013b57:
      ...
      *(undefined2 *)((int)puVar23 + -2) = unaff_CS;
      iVar11 = CONCAT11(cVar13 - *(byte *)((int)unaff_SI + in_BX + 0x23c9),
