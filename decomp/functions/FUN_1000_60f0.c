...
int FUN_1000_60f0(undefined2 param_1,int param_2,undefined2 *param_3)

{
  ...
  iVar8 = (*unaff_SI & 0xff) * (in_CX & 0xff) + *(int *)(in_BX + 2);
  pbVar18 = (byte *)(in_BX + 4);
  *(int *)pbVar18 = iVar8;
  bVar17 = (byte)((uint)in_DX >> 8);
  bVar14 = (byte)in_DX & in_stack_00000000[unaff_BP + 0x50];
  uVar15 = CONCAT11(bVar17,bVar14);
  bVar6 = (byte)(in_CX >> 8);
  cVar13 = bVar6 + pbVar18[(int)in_stack_00000000];
  ...
  if (iVar12 == 0 || cVar13 == '\0') {
    ...
    *unaff_DI = (char)iVar8 - 0x18;
    cVar13 = bVar14 + in_stack_00000000[unaff_BP];
    uVar16 = CONCAT11(bVar17,cVar13);
...
LAB_1000_5fc7:
    ...
    if ((0x7f < bVar6) && ((bVar6 < 0xa0 || (0xdf < bVar6)))) {
      pbVar4 = in_stack_00000000;
      in_stack_00000000 = in_stack_00000000 + 1;
      uVar25 = CONCAT22(uVar16,CONCAT11(bVar6,*pbVar4));
...
LAB_1000_625d:
        ...
        do {
          ...
          *(uint *)(pbVar22 + 0x50) = uVar7;
          ...
          iVar12 = CONCAT11(bVar6,CARRY2(uVar9,uVar9));
          uVar7 = uVar9 | uVar5 | uVar9 >> 1;
          bVar14 = (byte)(uVar7 >> 8);
          iVar10 = CONCAT11((char)uVar7,bVar14);
        ...
        *(byte *)(puVar20 + uVar9) = (byte)puVar20[uVar9] + bVar6 + (((uint)pbVar21 & 1) != 0);
        ...
        if ((uVar7 & 0x800) == 0) {
          *(byte *)(puVar19 + 0x1a4) = (byte)puVar19[0x1a4] + (char)(uVar11 >> 8);
          ...
          pbVar4 = (byte *)((int)puVar20 + iVar12 + 0x10);
          *pbVar4 = *pbVar4 | (byte)(uVar9 >> 1);
          *(byte *)(iVar12 + (int)puVar20) = *(byte *)(iVar12 + (int)puVar20) << 1;
          LOCK();
          pbVar4 = (byte *)((int)puVar20 + iVar12 + 0x30ac);
          *pbVar4 = *pbVar4 ^ bVar6;
          UNLOCK();
        }
        iVar10 = *(int *)0x32a8;
        ...
        piVar2 = (int *)(iVar12 + iVar10 + 0x10ff);
