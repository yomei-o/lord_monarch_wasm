...
int FUN_1000_56d9(int param_1,code *param_2,byte *param_3)
...
LAB_1000_571b:
      ...
      unaff_SI[in_BX] = unaff_SI[in_BX] | extraout_AL;
      iVar5 = 0;
      bVar6 = extraout_DL;
      cVar7 = extraout_DH;
      bVar3 = extraout_AL;
    ...
    unaff_BP = unaff_BP + *(int *)(unaff_SI + in_BX + 9);
    *(int *)(unaff_SI + in_BX) = *(int *)(unaff_SI + in_BX) + unaff_BP;
    ...
    if (!(bool)in_CF) {
      uVar10 = 0;
      unaff_SI[in_BX + -0x3ccc] = unaff_SI[in_BX + -0x3ccc] ^ (byte)(uVar4 - *puVar1);
...
code_r0x0001570a:
    ...
    bVar11 = in_stack_00000000 != 1;
    in_stack_00000000 = in_BX;
  } while (bVar11);
  bVar3 = 0xff;
  iVar5 = 0;
  goto LAB_1000_5771;
