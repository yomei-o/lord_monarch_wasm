...

{
  ...
  *unaff_SI = *unaff_SI + (int)unaff_SI;
  iVar10 = CONCAT11((char)((uint)in_CX >> 8),(char)in_CX + (char)*unaff_DI);
  bVar15 = false;
  bVar6 = ((byte)(in_AX + 1) | (byte)((uint)in_DX >> 8)) ^ *(byte *)(in_BX + (int)in_DX);
  bVar17 = bVar6 == 0;
  if (!bVar17) {
    *(byte *)0xbb = *(byte *)0xbb ^ bVar6 + 0xb4;
    (unaff_BP + (int)in_DX)[-0x80] = (unaff_BP + (int)in_DX)[-0x80] | (byte)((uint)(in_AX + 1) >> 8)
    ;
    *unaff_BP = bVar6 + 0xb4;
    ...
    *pbVar1 = *pbVar1 + bVar12;
    if (*pbVar1 == 0 || SCARRY1(bVar6,bVar12) != (char)*pbVar1 < '\0') {
      while (uVar11 = uStack_6, !(bool)uVar16) {
        ...
        *(byte *)(puVar13 + 9) = (char)puVar13[9] + bVar6 + (uVar8 < *(uint *)((int)puVar14 + 1));
        ...
        uVar16 = 0xf4 < (byte)(cVar5 + 1U) || CARRY1(cVar5 + 0xc,0x74 < bVar6);
                    /* WARNING: Call to offcut address within same function */
        uStack_6 = 0x55db;
    ...
    in_BX = CONCAT11(bVar12,(char)in_BX + *(char *)(in_BX + (int)in_DX));
  ...
  if (iVar10 == 1 || bVar17) {
    puVar2 = in_DX;
    uVar16 = CARRY2(*puVar2,in_BX) || CARRY2(*puVar2 + in_BX,(uint)bVar15);
    *puVar2 = *puVar2 + in_BX + (uint)bVar15;
    FUN_1000_5820();
    FUN_1000_56a1();
    if (!(bool)uVar16) {
      uVar9 = FUN_1000_5c30();
  ...
  *(char *)in_DX = (char)*in_DX + (char)uVar9 + -0x45;
  uVar18 = FUN_1000_5782(0x5060);
  if ((int)uVar18 == *(int *)0x3e98) {
    out(*in_DX,(int)((ulong)uVar18 >> 0x10));
  }
