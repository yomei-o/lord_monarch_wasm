    ...
    *(uint *)(in_BX + unaff_SI + 0x4702) = unaff_SI;
    if ((int)&stack0x0001 < 0) {
      *(uint *)(in_BX + unaff_SI + 2) = unaff_SI;
      cVar11 = *(char *)0xd089;
      *(undefined2 *)(in_BX + unaff_SI + -0x56) = CONCAT11(cVar12,cVar6 + *unaff_DI);
      pcVar3 = unaff_DI;
      unaff_DI = unaff_DI + 1;
      *pcVar3 = cVar6;
      cVar5 = *(char *)(in_BX + unaff_SI + -0x77);
      *(byte *)(unaff_BP + -0x76) = *(byte *)(unaff_BP + -0x76) ^ cVar4 + 0x10U;
      if ((3 < (byte)(cVar6 - 0x14U)) &&
         (iVar8 = CONCAT11(cVar12 + cVar11 + cVar5,cVar6 + -8),
